...
public class iAgreeBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements iAgreeVisitor<T> {
     ...
     */
    @Override
    public T visitPartiesRoles_prop(@NotNull iAgreeParser.PartiesRoles_propContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitCompensationElement(@NotNull iAgreeParser.CompensationElementContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitLocalDescription(@NotNull iAgreeParser.LocalDescriptionContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitConsumer_prop(@NotNull iAgreeParser.Consumer_propContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitProvider_prop(@NotNull iAgreeParser.Provider_propContext ctx) {
        return visitChildren(ctx);
    }
