...
public class iAgreeParser extends Parser {
	...
	public final PropertyContext property() throws RecognitionException {
		...
		try {
			...
			case DEFINED_AT:
				{
				setState(376); match(DEFINED_AT);
				setState(377); ((PropertyContext)_localctx).defineAT = url();
				}
				break;
			case 3:
				break;
	...
	public final ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(392); match(ASSIG);
				setState(393); expression(17);
				}
				break;
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 8:
						...
						setState(427); match(IFF);
						setState(428); expression(9);
						}
						break;
					...
					case 9:
						...
						setState(430); match(EXCLUDES);
						setState(431); expression(8);
						}
						break;
					...
					case 10:
						...
						setState(434); ((DuringExprContext)_localctx).state = expression(0);
						setState(435); ((DuringExprContext)_localctx).op = match(BY);
						setState(436); ((DuringExprContext)_localctx).dur = expression(0);
						setState(437); ((DuringExprContext)_localctx).durInt = duringInterval();
						}
						break;
					...
					case 11:
						...
						setState(440); match(IN);
						setState(441); ((FreqExprContext)_localctx).state = expression(0);
						setState(442);
						...
						consume();
						setState(443); ((FreqExprContext)_localctx).ntimes = expression(0);
						setState(444); ((FreqExprContext)_localctx).compInt = compensationsInterval();
						}
						break;
					}
					} 
	...
	public final ListContext list() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(451); match(CA);
			setState(452); ((ListContext)_localctx).l1 = args();
			setState(457);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==1) {
				...
				setState(454); ((ListContext)_localctx).l2 = args();
				}
				}
				setState(459);
				_errHandler.sync(this);
	...
	public final ArrayContext array() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(462); match(LLA);
			setState(463); ((ArrayContext)_localctx).l1 = args();
			setState(468);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==1) {
				...
				setState(465); ((ArrayContext)_localctx).l2 = args();
				}
				}
				setState(470);
				_errHandler.sync(this);
	...
	public final AtomContext atom() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				enterOuterAlt(_localctx, 3);
				{
				setState(477); ((ArrayAtomContext)_localctx).id = match(Identifier);
				setState(478); match(CA);
				setState(479); ((ArrayAtomContext)_localctx).value = match(String);
				setState(480); match(CC);
				}
				break;
	...
	public static final String _serializedATN =
		...
		"\3(\3(\3(\3(\3(\3(\3(\3(\3(\3(\3(\3(\3(\3(\3(\3(\3(\3(\3(\3(\3(\7(\u01c1"+
		"\n(\f(\16(\u01c4\13(\3)\3)\3)\3)\7)\u01ca\n)\f)\16)\u01cd\13)\3)\3)\3"+
		"*\3*\3*\3*\7*\u01d5\n*\f*\16*\u01d8\13*\3*\3*\3+\3+\3,\3,\3,\3,\3,\3,"+
		"\3,\3,\5,\u01e6\n,\3,\2-\2\4\6\b\n\f\16\20\22\24\26\30\32\34\36 \"$&("+
		"*,.\60\62\64\668:<>@BDFHJLNPRTV\2\30\4\2kkww\3\2\r\16\3\2(,\3\2#$\3\2"+
		"CD\3\2\65;\3\2<B\4\2nnrr\4\2qqww\4\2kkuu\5\2((MMkk\3\2TV\3\2lm\3\2`a\3"+
		"\2^_\4\2bcfg\3\2de\3\2Z[\4\2bdfg\4\2koww\3\2lo\3\2/\60\u01fc\2a\3\2\2"+
		"\2\4c\3\2\2\2\6i\3\2\2\2\bv\3\2\2\2\n\177\3\2\2\2\f\u0089\3\2\2\2\16\u0091"+
		"\3\2\2\2\20\u0093\3\2\2\2\22\u009b\3\2\2\2\24\u00a1\3\2\2\2\26\u00a8\3"+
