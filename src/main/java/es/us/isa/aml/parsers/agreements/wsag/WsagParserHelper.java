...
public class WsagParserHelper {
    ...
    public void setContext() {
        ...
        if (serviceProvider != null && serviceProvider instanceof Element) {
            String roleType = serviceProvider.getTextContent()
                    .trim();
            if(roleType.contains("Agreement"))
                roleType = roleType.replace("Agreement", "");
            provider = AgreementRole.valueOf(roleType);
        }
