...
public class ExpressionParser extends Parser {
	...
	public static final int
		BOOLEAN=1, INTEGER=2, FLOAT=3, NATURAL=4, NUMBER=5, SET=6, ENUM=7, TRUE=8, 
	...
	public static final int
		RULE_parse = 0, RULE_expression = 1, RULE_atom = 2;
	...
	public final ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(10); match(ASSIG);
				setState(11); expression(10);
				}
				break;
			...
			case 2:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(12); match(NOT);
				setState(13); expression(9);
				}
				break;
			...
			case 3:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(14); match(PA);
				setState(15); expression(0);
				setState(16); match(PC);
				}
				break;
