...
public class ExpressionParser extends Parser {
    ...
    public static final String[] tokenNames = {
        "<INVALID>", "'boolean'", "'integer'", "'float'", "'natural'", "'number'",
        "'set'", "'enum'", "'true'", "'false'", "'['", "']'", "'('", "')'", "'{'",
        "'}'", "'AND'", "'OR'", "'NOT'", "'IMPLIES'", "'+'", "'-'", "'*'", "'/'",
        "'<'", "'>'", "'=='", "'!='", "'<='", "'>='", "'='", "'belongs'", "'upon'",
        "Identifier", "Integer", "S_Integer", "Float", "S_Float", "Boolean", "String",
        "WS", "COMMENT", "LINE_COMMENT"
    };
    public static final int RULE_parse = 0, RULE_expression = 1, RULE_atom = 2;
    public static final String[] ruleNames = {
        "parse", "expression", "atom"
    };
    public static final String _serializedATN = "\3\uacf5\uee8c\u4f5d\u8b0d\u4a45\u78bd\u1b2f\u3378\3,\65\4\2\t\2\4\3\t"
            + "\3\4\4\t\4\3\2\3\2\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\5\3\26"
            + "\n\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3"
            + "\3\3\3\7\3*\n\3\f\3\16\3-\13\3\3\4\3\4\3\4\3\4\5\4\63\n\4\3\4\2\5\2\4"
            + "\6\2\b\3\2\30\31\3\2\26\27\4\2\32\33\36\37\3\2\34\35\3\2$\'\3\2\n\13="
            + "\2\b\3\2\2\2\4\25\3\2\2\2\6\62\3\2\2\2\b\t\5\4\3\2\t\3\3\2\2\2\n\13\b"
            + "\3\1\2\13\f\7#\2\2\f\r\7 \2\2\r\26\5\4\3\2\16\17\7\24\2\2\17\26\5\4\3"
            + "\2\20\21\7\16\2\2\21\22\5\4\3\2\22\23\7\17\2\2\23\26\3\2\2\2\24\26\5\6"
            + "\4\2\25\n\3\2\2\2\25\16\3\2\2\2\25\20\3\2\2\2\25\24\3\2\2\2\26+\3\2\2"
            + "\2\27\30\6\3\2\3\30\31\t\2\2\2\31*\5\4\3\2\32\33\6\3\3\3\33\34\t\3\2\2"
            + "\34*\5\4\3\2\35\36\6\3\4\3\36\37\t\4\2\2\37*\5\4\3\2 !\6\3\5\3!\"\t\5"
            + "\2\2\"*\5\4\3\2#$\6\3\6\3$%\7\22\2\2%*\5\4\3\2&\'\6\3\7\3\'(\7\23\2\2"
            + "(*\5\4\3\2)\27\3\2\2\2)\32\3\2\2\2)\35\3\2\2\2) \3\2\2\2)#\3\2\2\2)&\3"
            + "\2\2\2*-\3\2\2\2+)\3\2\2\2+,\3\2\2\2,\5\3\2\2\2-+\3\2\2\2.\63\t\6\2\2"
            + "/\63\t\7\2\2\60\63\7#\2\2\61\63\7)\2\2\62.\3\2\2\2\62/\3\2\2\2\62\60\3"
            + "\2\2\2\62\61\3\2\2\2\63\7\3\2\2\2\6\25)+\62";
    ...
    public static class ParseContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor) {
                return ((ExpressionVisitor<? extends T>) visitor).visitParse(this);
            } else {
    ...
    public static class AssigExprContext extends ExpressionContext {
        ...
        public TerminalNode ASSIG() {
            return getToken(ExpressionParser.ASSIG, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor) {
                return ((ExpressionVisitor<? extends T>) visitor).visitAssigExpr(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class ParExprContext extends ExpressionContext {
        ...
        public TerminalNode PA() {
            return getToken(ExpressionParser.PA, 0);
        }
        ...
        public TerminalNode PC() {
            return getToken(ExpressionParser.PC, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor) {
                return ((ExpressionVisitor<? extends T>) visitor).visitParExpr(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class AndExprContext extends ExpressionContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor) {
                return ((ExpressionVisitor<? extends T>) visitor).visitAndExpr(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class RelationalExprContext extends ExpressionContext {
        ...
        public TerminalNode GTE() {
            return getToken(ExpressionParser.GTE, 0);
        }

        public TerminalNode LT() {
            return getToken(ExpressionParser.LT, 0);
        }

        public TerminalNode LTE() {
            return getToken(ExpressionParser.LTE, 0);
        }
        ...
        public TerminalNode GT() {
            return getToken(ExpressionParser.GT, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor) {
                return ((ExpressionVisitor<? extends T>) visitor).visitRelationalExpr(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class AtomExprContext extends ExpressionContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor) {
                return ((ExpressionVisitor<? extends T>) visitor).visitAtomExpr(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class AdditiveExprContext extends ExpressionContext {
        ...
        public TerminalNode SUBTRACT() {
            return getToken(ExpressionParser.SUBTRACT, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor) {
                return ((ExpressionVisitor<? extends T>) visitor).visitAdditiveExpr(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class EqualityExprContext extends ExpressionContext {
        ...
        public TerminalNode NEQ() {
            return getToken(ExpressionParser.NEQ, 0);
        }
        ...
        public TerminalNode EQ() {
            return getToken(ExpressionParser.EQ, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor) {
                return ((ExpressionVisitor<? extends T>) visitor).visitEqualityExpr(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class MultiplicationExprContext extends ExpressionContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor) {
                return ((ExpressionVisitor<? extends T>) visitor).visitMultiplicationExpr(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class NotExprContext extends ExpressionContext {
        ...
        public TerminalNode NOT() {
            return getToken(ExpressionParser.NOT, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor) {
                return ((ExpressionVisitor<? extends T>) visitor).visitNotExpr(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class OrExprContext extends ExpressionContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor) {
                return ((ExpressionVisitor<? extends T>) visitor).visitOrExpr(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class IdAtomContext extends AtomContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor) {
                return ((ExpressionVisitor<? extends T>) visitor).visitIdAtom(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class StringAtomContext extends AtomContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor) {
                return ((ExpressionVisitor<? extends T>) visitor).visitStringAtom(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class NumberAtomContext extends AtomContext {
        ...
        public TerminalNode Integer() {
            return getToken(ExpressionParser.Integer, 0);
        }

        public TerminalNode S_Float() {
            return getToken(ExpressionParser.S_Float, 0);
        }

        public TerminalNode Float() {
            return getToken(ExpressionParser.Float, 0);
        }

        public TerminalNode S_Integer() {
            return getToken(ExpressionParser.S_Integer, 0);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor) {
                return ((ExpressionVisitor<? extends T>) visitor).visitNumberAtom(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class BooleanAtomContext extends AtomContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExpressionVisitor) {
                return ((ExpressionVisitor<? extends T>) visitor).visitBooleanAtom(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
