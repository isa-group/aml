...
public class AgreementManager {
     ...
     *
     * @param path The path to the agreement file
     ...
     *
     * @param path The path to the agreement file
     * @param lang The language of the agreement file
     * @return The Agreement object
     * @see Agreement
     ...
     * provided.
     *
     * @param path The path to the offer file
     ...
     *
     * @param path The path to the offer file
     * @param lang The language of the offer file
     * @return The AgreementOffer object
     * @see AgreementOffer
     * @see AgreementLanguage
     */
     ...
     *
     * @param path The path to the template file
     * @param lang The language of the template file
     * @return The AgreementTemplate object
     * @see AgreementTemplate
     * @see AgreementLanguage
     */
     ...
     *
     * @param template The AgreementTemplate to register
     * @see Store
     */
     ...
     *
     * @param offer The AgreementOffer to register
     * @see Store
     */
    ...
    public Boolean isValid(AgreementModel agreementModel) {
        ...
        return op.getResult().isValid();
    }

    public OperationResult isValidFullResponse(AgreementModel agreementModel) {
        Valid op = new Valid();
        op.analyze(agreementModel);
        return op.getResult();
    }
