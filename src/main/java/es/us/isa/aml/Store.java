...
public class Store {
    ...
    private Map<String, AgreementModel> agreementModelMap;
     ...
     * @param lang The language of the agreement
     * @param manager The current agreement manager
     ...
     *
     * @param content The offer content
     * @param lang The language of the offer
     * @param manager The current agreement manager
     ...
     * Parse and register a file in the store map.
     *
     * @param file The File object to register
     */
    ...
    /**
     * Parse and register all the files contained in the folder provided. You
     * can specify a boolean to determine if a recursive search is needed or
     * not.
     *
     * @param folderPath The path to the folder that contains all the files
     * @param recursive The Boolean that determines if a recursive search is
     * needed
     */
    ...
    /**
     * Register an AgreementModel using the name provided as the key of the
     * store map.
     *
    ...
    public Agreement getAgreement(String name) {
        try {
            return (Agreement) agreementModelMap.get(name);
        } catch (ClassCastException e) {
            return null;
        }
    }
     ...
     *
     * @return An unmodifiable view of the map that contains all the agreement
     * models
     */
