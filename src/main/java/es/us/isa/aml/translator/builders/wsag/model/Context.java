...
public class Context {
    ...
    /**
     * @param agreementInitiator the agreementInitiator to set
     */
    ...
    /**
     * @param agreementResponder the agreementResponder to set
     */
    ...
    public String toString() {
        ...
        if (getAgreementResponder() != null) {
            sb.append("\t\t" + "<wsag:AgreementResponder id=").append(getAgreementResponder().getId()).append(">").append(getAgreementResponder().getRoleType().toString()).append("</wsag:AgreementResponder>").append("\n");
        }
