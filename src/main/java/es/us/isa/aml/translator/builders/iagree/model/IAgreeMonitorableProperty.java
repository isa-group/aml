...
public class IAgreeMonitorableProperty extends MonitorableProperty {
    ...
    public IAgreeMonitorableProperty(Property mp) {
        super(mp.getId(), mp.getMetric(), mp.getDefinitionReference(), mp.getExpression(), mp.getScope(), mp.getFeature());
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append(this.getId()).append(": ").append(this.getMetric().getId());
        ...
        if (this.getExpression() != null) {
            sb.append(" = ").append(this.getExpression());
        }
