...
public class MonitorableProperty extends Property {
    ...
    public MonitorableProperty(String id, Metric metric, String definitionReference, Expression expression,
            Scope scope, Feature feature) {
        super(id, metric, definitionReference, expression, scope, feature);
    }
