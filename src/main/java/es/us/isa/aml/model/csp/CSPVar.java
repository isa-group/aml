...
public class CSPVar {
    ...
    public String toString() {
        if (this.dvar) {
            ...
            } else if (getRange().getId() != null) {
                return "dvar " + this.getType() + " " + this.getId()
                        + " in " + getRange().getId() + ";";
            } else {
                return "dvar " + this.getType() + " " + this.getId()
                        + " in " + getRange().getDomain() + ";";
            }
            ...
            if (getExpression() != null) {
                sb.append(this.getType()).append(" ").append(this.getId()).append(" = ").append(getExpression().toString());
            } else {
                sb.append(this.getType()).append(" ").append(this.getId());
            }
            sb.append(";");
            return sb.toString();
