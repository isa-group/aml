...
/**
 * Checks if a document is consistent. In other words, this operations checks
 * the document has no errors that invalidate it
 */
public interface ConsistencyOperation extends Operation {

    /**
     * Returns true if the document is consistent, and false in other case
     *
