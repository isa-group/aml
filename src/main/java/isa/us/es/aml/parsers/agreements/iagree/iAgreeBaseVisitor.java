...
public class iAgreeBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements iAgreeVisitor<T> {
     ...
     */
    @Override
    public T visitAgreementTerms_def(@NotNull iAgreeParser.AgreementTerms_defContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitType(@NotNull iAgreeParser.TypeContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitGrouped_guaranteeTerm(@NotNull iAgreeParser.Grouped_guaranteeTermContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitId(@NotNull iAgreeParser.IdContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitAssig_value(@NotNull iAgreeParser.Assig_valueContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitKey_value_prop(@NotNull iAgreeParser.Key_value_propContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitOp(@NotNull iAgreeParser.OpContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitExpression(@NotNull iAgreeParser.ExpressionContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitCreationConstraints_def(@NotNull iAgreeParser.CreationConstraints_defContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitOperation(@NotNull iAgreeParser.OperationContext ctx) {
        return visitChildren(ctx);
    }
