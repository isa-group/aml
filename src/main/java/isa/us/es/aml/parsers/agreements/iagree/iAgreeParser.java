...
public class iAgreeParser extends Parser {
    ...
    public static class AgreementTerms_defContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_agreementTerms_def;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof iAgreeVisitor) {
                return ((iAgreeVisitor<? extends T>) visitor).visitAgreementTerms_def(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class CreationConstraints_defContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_creationConstraints_def;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof iAgreeVisitor) {
                return ((iAgreeVisitor<? extends T>) visitor).visitCreationConstraints_def(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class Grouped_guaranteeTermContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_grouped_guaranteeTerm;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof iAgreeVisitor) {
                return ((iAgreeVisitor<? extends T>) visitor).visitGrouped_guaranteeTerm(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public final CompensationContext compensation() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                match(OF);
                setState(417);
                ((CompensationContext) _localctx).e1 = expression();
                setState(418);
                match(IF);
                setState(419);
                ((CompensationContext) _localctx).e2 = expression();
                setState(420);
                match(2);
            }
        } catch (RecognitionException re) {
    ...
    public static class IdContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof iAgreeVisitor) {
                return ((iAgreeVisitor<? extends T>) visitor).visitId(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class Key_value_propContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_key_value_prop;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof iAgreeVisitor) {
                return ((iAgreeVisitor<? extends T>) visitor).visitKey_value_prop(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                switch (_input.LA(1)) {
                    case String: {
                        setState(430);
                        ((Key_value_propContext) _localctx).v = match(String);
                    }
                    break;
                    case BOOLEAN:
                    case INTEGER:
                    ...
                    case Identifier: {
                        setState(431);
                        ((Key_value_propContext) _localctx).v2 = type();
                    }
                    break;
                    default:
                        throw new NoViableAltException(this);
                ...
                if (_la == EQ) {
                    {
                        ...
                        match(EQ);
                        setState(435);
                        ((Key_value_propContext) _localctx).a = assig_value();
                        setState(436);
                        match(2);
                    }
                }
    ...
    public static class Assig_valueContext extends ParserRuleContext {
        ...
        public List<TerminalNode> String() {
            return getTokens(iAgreeParser.String);
        }
        ...
        public TerminalNode Unit() {
            return getToken(iAgreeParser.Unit, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_assig_value;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof iAgreeVisitor) {
                return ((iAgreeVisitor<? extends T>) visitor).visitAssig_value(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class OperationContext extends ParserRuleContext {
        ...
        public TerminalNode Operador() {
            return getToken(iAgreeParser.Operador, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof iAgreeVisitor) {
                return ((iAgreeVisitor<? extends T>) visitor).visitOperation(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class ExpressionContext extends ParserRuleContext {
        ...
        public TerminalNode IMPLIES() {
            return getToken(iAgreeParser.IMPLIES, 0);
        }
        ...
        public TerminalNode BELONGS() {
            return getToken(iAgreeParser.BELONGS, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof iAgreeVisitor) {
                return ((iAgreeVisitor<? extends T>) visitor).visitExpression(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
                        ...
                        if (((((_la - 73)) & ~0x3f) == 0 && ((1L << (_la - 73)) & ((1L << (LT - 73)) | (1L << (GT - 73)) | (1L << (EQ - 73)) | (1L << (LTE - 73)) | (1L << (GTE - 73)))) != 0)) {
                            {
                                ...
                                consume();
                                setState(487);
                                ((ExpressionContext) _localctx).val = assig_value();
                            }
                        }
                    ...
                    enterOuterAlt(_localctx, 4);
                     {
                        ...
                        match(BELONGS);
                        setState(496);
                        ((ExpressionContext) _localctx).l = list();
                        setState(499);
                        _la = _input.LA(1);
                        if (((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (AND - 65)) | (1L << (OR - 65)) | (1L << (IMPLIES - 65)))) != 0)) {
                            {
    ...
    public static class OpContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof iAgreeVisitor) {
                return ((iAgreeVisitor<? extends T>) visitor).visitOp(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
    ...
    public static class TypeContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof iAgreeVisitor) {
                return ((iAgreeVisitor<? extends T>) visitor).visitType(this);
            } else {
                return visitor.visitChildren(this);
            }
        }
