...
public class iAgreeParser extends Parser {
    ...
    public static final String _serializedATN = "\3\uacf5\uee8c\u4f5d\u8b0d\u4a45\u78bd\u1b2f\u3378\3g\u01ff\4\2\t\2\4"
    ...
    public EntryContext entry() throws RecognitionException {
    ...
    public TemplateContext template() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                match(VERSION);
                setState(113);
                _localctx.version = versionNumber();
                setState(114);
                template_def();
            }
        } catch (RecognitionException re) {
    ...
    public AgOfferContext agOffer() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                setState(124);
                _localctx.templateId = match(Identifier);
                setState(125);
                match(VERSION);
                setState(126);
                _localctx.templateVersion = versionNumber();
                setState(127);
                ag_def();
            }
        } catch (RecognitionException re) {
    ...
    public Template_defContext template_def() throws RecognitionException {
    ...
    public Ag_defContext ag_def() throws RecognitionException {
    ...
    public Temp_propertiesContext temp_properties() throws RecognitionException {
    ...
    public AgreementTermsContext agreementTerms() throws RecognitionException {
    ...
    public CreationConstraintsContext creationConstraints() throws RecognitionException {
    ...
    public CreationConstraintContext creationConstraint() throws RecognitionException {
    ...
    public Initiator_propContext initiator_prop() throws RecognitionException {
    ...
    public Responder_propContext responder_prop() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                setState(180);
                _la = _input.LA(1);
                if (!(((((_la - 29)) & ~0x3f) == 0 && ((1L << (_la - 29)) & ((1L) | (1L << (CONSUMER - 29)) | (1L << (Identifier - 29)))) != 0))) {
    ...
    public ServiceProvider_propContext serviceProvider_prop() throws RecognitionException {
    ...
    public ExpirationTime_propContext expirationTime_prop() throws RecognitionException {
    ...
    public DateFormat_propContext dateFormat_prop() throws RecognitionException {
    ...
    public GmtZone_propContext gmtZone_prop() throws RecognitionException {
    ...
    public GlobalPeriod_propContext globalPeriod_prop() throws RecognitionException {
    ...
    public DefinedPeriod_propContext definedPeriod_prop() throws RecognitionException {
    ...
    public Metrics_propContext metrics_prop() throws RecognitionException {
    ...
    public MetricContext metric() throws RecognitionException {
    ...
    public DatePeriod_defContext datePeriod_def() throws RecognitionException {
    ...
    public TemporalityContext temporality() throws RecognitionException {
    ...
    public PeriodContext period() throws RecognitionException {
    ...
    public Period_defContext period_def() throws RecognitionException {
    ...
    public ServiceContext service() throws RecognitionException {
    ...
    public FeaturesContext features() throws RecognitionException {
    ...
    public FeatureContext feature() throws RecognitionException {
    ...
    public GlobalDescriptionContext globalDescription() throws RecognitionException {
    ...
    public DescriptionsContext descriptions() throws RecognitionException {
    ...
    public DescriptionContext description() throws RecognitionException {
    ...
    public MonitorablePropertiesContext monitorableProperties() throws RecognitionException {
    ...
    public Global_MonitorablePropertiesContext global_MonitorableProperties() throws RecognitionException {
    ...
    public Local_MonitorablePropertiesContext local_MonitorableProperties() throws RecognitionException {
    ...
    public GuaranteeTermsContext guaranteeTerms() throws RecognitionException {
    ...
    public GuaranteeTermContext guaranteeTerm() throws RecognitionException {
    ...
    public Guarantee_defContext guarantee_def() throws RecognitionException {
        ...
        try {
            ...
            {
                setState(370);
                _localctx.ob = _input.LT(1);
                _la = _input.LA(1);
                if (!(_la == PROVIDER || _la == CONSUMER)) {
                    _localctx.ob = _errHandler.recoverInline(this);
                }
                consume();
                setState(371);
                match(GUARANTEES);
    ...
    public SloContext slo() throws RecognitionException {
    ...
    public ServiceScopeContext serviceScope() throws RecognitionException {
    ...
    public QualifyingConditionContext qualifyingCondition() throws RecognitionException {
    ...
    public CompensationsContext compensations() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                match(WITH);
                setState(402);
                _localctx.interv = compensationsInterval();
                setState(403);
                _localctx.compType = _input.LT(1);
                _la = _input.LA(1);
                if (!(_la == PENALTY || _la == REWARD)) {
                    _localctx.compType = _errHandler.recoverInline(this);
                }
                consume();
                setState(405);
                _errHandler.sync(this);
    ...
    public CompensationsIntervalContext compensationsInterval() throws RecognitionException {
    ...
    public CompensationContext compensation() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                match(OF);
                setState(414);
                _localctx.e1 = expression(0);
                setState(415);
                match(IF);
                setState(416);
                _localctx.e2 = expression(0);
                setState(417);
                match(3);
            }
        } catch (RecognitionException re) {
    ...
    public VersionNumberContext versionNumber() throws RecognitionException {
    ...
    public UrlContext url() throws RecognitionException {
    ...
    public PropertyContext property() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                match(2);
                setState(425);
                _localctx.met = _input.LT(1);
                _la = _input.LA(1);
                if (!(_la == BOOLEAN || _la == Identifier)) {
                    _localctx.met = _errHandler.recoverInline(this);
                }
                consume();
                setState(430);
                _la = _input.LA(1);
                            ...
                            switch (getInterpreter().adaptivePredict(_input, 40, _ctx)) {
                                case 1: {
                                    ...
                                    if (!(_la == MULTIPLY || _la == DIVIDE)) {
                                        ((MultiplicationExprContext) _localctx).op = _errHandler.recoverInline(this);
                                    }
                                    consume();
                                    setState(443);
                                    expression(8);
                                ...
                                case 3: {
                                    ...
                                    _la = _input.LA(1);
                                    if (!(((((_la - 73)) & ~0x3f) == 0 && ((1L << (_la - 73)) & ((1L) | (1L << (GT - 73)) | (1L << (LTE - 73)) | (1L << (GTE - 73)))) != 0))) {
    ...
    public AtomContext atom() throws RecognitionException {
                    ...
                    enterOuterAlt(_localctx, 2);
                     {
                        setState(468);
                        _la = _input.LA(1);
                        if (!(((((_la - 87)) & ~0x3f) == 0 && ((1L << (_la - 87)) & ((1L) | (1L << (S_Integer - 87)) | (1L << (Float - 87)) | (1L << (S_Float - 87)))) != 0))) {
                            _errHandler.recoverInline(this);
                        }
                        consume();
                    }
    ...
    public Feature_operationContext feature_operation() throws RecognitionException {
    ...
    public CuantifContext cuantif() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                setState(487);
                _la = _input.LA(1);
                if (!(((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & ((1L) | (1L << (ONE_OR_MORE - 70)) | (1L << (ALL - 70)))) != 0))) {
                    _errHandler.recoverInline(this);
                }
                consume();
            }
    ...
    public ListContext list() throws RecognitionException {
    ...
    public ListArgContext listArg() throws RecognitionException {
        ...
        try {
            ...
            {
                setState(500);
                _localctx.l1 = _input.LT(1);
                _la = _input.LA(1);
                if (!(((((_la - 86)) & ~0x3f) == 0 && ((1L << (_la - 86)) & ((1L) | (1L << (Integer - 86)) | (1L << (S_Integer - 86)) | (1L << (Float - 86)) | (1L << (S_Float - 86)) | (1L << (String - 86)))) != 0))) {
                    _localctx.l1 = _errHandler.recoverInline(this);
                }
                consume();
            }
        } catch (RecognitionException re) {
    ...
    public RangeContext range() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                match(CA);
                setState(503);
                _localctx.min = _input.LT(1);
                _la = _input.LA(1);
                if (!(_la == Integer || _la == S_Integer)) {
                    _localctx.min = _errHandler.recoverInline(this);
                }
                consume();
                setState(504);
                match(4);
                setState(505);
                _localctx.max = _input.LT(1);
                _la = _input.LA(1);
                if (!(_la == Integer || _la == S_Integer)) {
                    _localctx.max = _errHandler.recoverInline(this);
                }
                consume();
                setState(506);
                match(CC);
