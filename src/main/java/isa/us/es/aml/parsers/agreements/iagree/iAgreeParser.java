...
public class iAgreeParser extends Parser {
	...
	public final TemplateContext template() throws RecognitionException {
		...
		try {
			...
			setState(111); ((TemplateContext)_localctx).id = match(Identifier);
			setState(112); match(VERSION);
			setState(113); ((TemplateContext)_localctx).version = versionNumber();
	...
	public final AgOfferContext agOffer() throws RecognitionException {
		...
		try {
			...
			setState(117); ((AgOfferContext)_localctx).id = match(Identifier);
			setState(118); match(VERSION);
			setState(119); ((AgOfferContext)_localctx).version = versionNumber();
			...
			setState(124); ((AgOfferContext)_localctx).templateId = match(Identifier);
			setState(125); match(VERSION);
			setState(126); ((AgOfferContext)_localctx).templateVersion = versionNumber();
			setState(127); ag_def();
			}
		}
		catch (RecognitionException re) {
	...
	public final Template_defContext template_def() throws RecognitionException {
		...
		try {
			...
			setState(135); agreementTerms();
			setState(137);
			_la = _input.LA(1);
			if (_la==CREATION_CONSTRAINTS) {
				{
				setState(136); creationConstraints();
				}
			}
	...
	public final Temp_propertiesContext temp_properties() throws RecognitionException {
		...
		try {
			...
			case Identifier:
				enterOuterAlt(_localctx, 2);
				{
				setState(148); responder_prop();
				}
				break;
			case SERVICEPROVIDER:
				enterOuterAlt(_localctx, 3);
				{
				setState(149); serviceProvider_prop();
				}
				break;
			case EXPIRATIONTIME:
				enterOuterAlt(_localctx, 4);
				{
				setState(150); expirationTime_prop();
				}
				break;
			case DATEFORMAT:
				enterOuterAlt(_localctx, 5);
				{
				setState(151); dateFormat_prop();
				}
				break;
			case GMTZONE:
				enterOuterAlt(_localctx, 6);
				{
				setState(152); gmtZone_prop();
				}
				break;
			case GLOBALPERIOD:
				enterOuterAlt(_localctx, 7);
				{
				setState(153); globalPeriod_prop();
				}
				break;
			case DEFINEDPERIOD:
				enterOuterAlt(_localctx, 8);
				{
				setState(154); definedPeriod_prop();
				}
				break;
			case METRICS:
				enterOuterAlt(_localctx, 9);
				{
				setState(155); metrics_prop();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final AgreementTermsContext agreementTerms() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(158); match(AGREEMENT_TERMS);
			setState(159); service();
			setState(160); monitorableProperties();
			setState(161); guaranteeTerms();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final CreationConstraintsContext creationConstraints() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(163); match(CREATION_CONSTRAINTS);
			setState(165); 
			_errHandler.sync(this);
			_la = _input.LA(1);
			do {
				{
				{
				setState(164); creationConstraint();
				}
				}
				setState(167); 
				_errHandler.sync(this);
	...
	public final CreationConstraintContext creationConstraint() throws RecognitionException {
		...
		try {
			...
			if (_la==ONLY_IF) {
				{
				setState(173); qualifyingCondition();
				}
			}
	...
	public final Responder_propContext responder_prop() throws RecognitionException {
		...
		try {
			...
			consume();
			setState(181); match(AS);
			setState(182); match(RESPONDER);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ServiceProvider_propContext serviceProvider_prop() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(184); match(SERVICEPROVIDER);
	...
	public final ExpirationTime_propContext expirationTime_prop() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(188); match(EXPIRATIONTIME);
	...
	public final GlobalPeriod_propContext globalPeriod_prop() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(200); match(GLOBALPERIOD);
			setState(201); match(2);
			setState(202); datePeriod_def();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final DefinedPeriod_propContext definedPeriod_prop() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(204); match(DEFINEDPERIOD);
	...
	public final MetricContext metric() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(218); ((MetricContext)_localctx).id = match(Identifier);
			setState(219); match(2);
			setState(231);
			switch (_input.LA(1)) {
			case SET:
				{
				setState(220); ((MetricContext)_localctx).type = match(SET);
				setState(221); list();
				}
				break;
			case ENUM:
				{
				setState(222); ((MetricContext)_localctx).type = match(ENUM);
				setState(223); list();
				}
				break;
			case BOOLEAN:
	...
	public final DatePeriod_defContext datePeriod_def() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(233); match(DURING);
			setState(234); match(Date);
			setState(235); match(4);
			setState(236); match(Date);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Period_defContext period_def() throws RecognitionException {
		...
		try {
			...
			case FROM:
				enterOuterAlt(_localctx, 1);
				{
				setState(251); match(FROM);
				setState(252); match(Hour);
				setState(253); match(4);
				setState(254); match(Hour);
				setState(257);
				_la = _input.LA(1);
				if (_la==ON) {
					{
					setState(255); match(ON);
					setState(256); match(Identifier);
					}
				}

				setState(259); datePeriod_def();
				}
				break;
			case Identifier:
				enterOuterAlt(_localctx, 2);
			...
			case GLOBALPERIOD:
				enterOuterAlt(_localctx, 3);
				{
				setState(261); match(GLOBALPERIOD);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final ServiceContext service() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(264); match(SERVICE);
			setState(265); match(Identifier);
			setState(268);
			_la = _input.LA(1);
			if (_la==AVAL_AT) {
				{
				setState(266); match(AVAL_AT);
				setState(267); url();
				}
			}
			...
			if (_la==FEATURES) {
				{
				setState(270); features();
				}
			}

			setState(273); globalDescription();
			setState(274); descriptions();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final FeatureContext feature() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(284); feature_operation();
			setState(289);
			_errHandler.sync(this);
	...
	public final GlobalDescriptionContext globalDescription() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(292); match(GLOBALDESCRIPTION);
			setState(294); 
			_errHandler.sync(this);
			_la = _input.LA(1);
			do {
	...
	public final GuaranteeTermsContext guaranteeTerms() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(348); match(GUARANTEE_TERMS);
			setState(352);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==Identifier) {
	...
	public final CompensationContext compensation() throws RecognitionException {
		...
		try {
			...
			setState(414); ((CompensationContext)_localctx).e1 = expression(0);
			setState(415); match(IF);
			setState(416); ((CompensationContext)_localctx).e2 = expression(0);
	...
	public final PropertyContext property() throws RecognitionException {
		...
		try {
			...
			if (_la==ASSIG) {
				{
				setState(426); match(ASSIG);
				setState(427); ((PropertyContext)_localctx).value = expression(0);
	...
	public final ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(434); match(ASSIG);
				setState(435); expression(9);
				}
				break;
	...
	public final AtomContext atom() throws RecognitionException {
		...
		try {
			...
			case PA:
				...
				enterOuterAlt(_localctx, 1);
				{
				setState(464); match(PA);
				setState(465); expression(0);
				setState(466); match(PC);
				}
				break;
			case Integer:
			case S_Integer:
	...
	public final ListContext list() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(489); match(LLA);
			setState(490); ((ListContext)_localctx).l1 = listArg();
			setState(495);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==1) {
				...
				setState(492); ((ListContext)_localctx).l2 = listArg();
				}
				}
				setState(497);
				_errHandler.sync(this);
