...
import isa.us.es.aml.parsers.agreements.iagree.iAgreeParser.AgreementTerms_defContext;
import isa.us.es.aml.parsers.agreements.iagree.iAgreeParser.Assig_valueContext;
...
import isa.us.es.aml.parsers.agreements.iagree.iAgreeParser.CreationConstraints_defContext;
...
import isa.us.es.aml.parsers.agreements.iagree.iAgreeParser.Grouped_guaranteeTermContext;
...
import isa.us.es.aml.parsers.agreements.iagree.iAgreeParser.IdContext;
import isa.us.es.aml.parsers.agreements.iagree.iAgreeParser.Initiator_propContext;
import isa.us.es.aml.parsers.agreements.iagree.iAgreeParser.Key_value_propContext;
...
import isa.us.es.aml.parsers.agreements.iagree.iAgreeParser.OpContext;
import isa.us.es.aml.parsers.agreements.iagree.iAgreeParser.OperationContext;
...
import isa.us.es.aml.parsers.agreements.iagree.iAgreeParser.TypeContext;
...
public class MiAgreeVisitor implements iAgreeVisitor<Object> {
    ...
    private static final Logger LOG = Logger.getLogger(MiAgreeVisitor.class.getName());
    ...
    public AgreementModel visitEntry(EntryContext ctx) {
        try {
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterEntry");
        }
    ...
    public Object visitTemplate(TemplateContext ctx) {
        try {
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterTemplate");
        }
    ...
    public Object visitAgOffer(AgOfferContext ctx) {
        try {
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterAgOffer");
        }
        return null;
    }
    ...
    public Object visitTemplate_def(Template_defContext ctx) {
        try {
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterTemplate_def");
        }
    ...
    public Object visitAg_def(Ag_defContext ctx) {
        try {
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterAg_def");
        }
    ...
    public Object visitAgreementTerms(AgreementTermsContext ctx) {
        try {
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterAgreementTerms");
        }
        return null;
    }
    ...
    public Object visitAgreementTerms_def(AgreementTerms_defContext ctx) {
        try {
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterAgreementTerms_def");
        }
        return null;
    }
    ...
    public Object visitCreationConstraints(CreationConstraintsContext ctx) {
        try {
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterCreationConstraints");
        }
    ...
    public Object visitCreationConstraints_def(
        ...
        try {
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterCreationConstraints_def");
        }
        return null;
    }
...
//			Expression exp = visitExpression(ctx.expression());
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterCreationConstraint");
        }
        return null;
    }
    ...
    public Object visitService(ServiceContext ctx) {
        try {
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterService");
        }
        return null;
    }
    ...
    public Object visitTemp_properties(Temp_propertiesContext ctx) {
        try {
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterTemp_properties");
        }
        return null;
    }
    ...
    public Object visitMonitorableProperties(MonitorablePropertiesContext ctx) {
        try {
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterMonitorableProperties");
        }
        return null;
    }
    ...
    public Object visitGuaranteeTerms(GuaranteeTermsContext ctx) {
        try {
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterGuaranteeTerms");
        }
        return null;
    }
    ...
    public Object visitGlobalDescription(GlobalDescriptionContext ctx) {
        try {
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterGlobalDescription");
        }
        return null;
    }
    ...
    public Range visitRange(RangeContext ctx) {
        ...
        try {
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterRange");
        }
    ...
    public Object visitMetrics_prop(Metrics_propContext ctx) {
        try {
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterMetrics_prop");
        }
    ...
    public Property visitKey_value_prop(Key_value_propContext ctx) {
        ...
        try {
            ...
            LOG.log(Level.WARNING, "iAgree parsing exception catched: enterKey_value_prop");
        }
