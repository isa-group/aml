...
public class TestStore {
	...
	public void testRegistration2a() {
		...
		AgreementTemplate template2a = m
				.createAgreementTemplateFromFile(path2a);
		s.register(template2a);
		AgreementTemplate template2aR = s.getAgreementTemplate(template2a
				.getID());
	...
	public void testRegistration2b() {
		...
		AgreementTemplate template2b = m
				.createAgreementTemplateFromFile(path2b);
	...
	public void testRegistration3a() {
		...
		AgreementTemplate template3a = m
				.createAgreementTemplateFromFile(path3a);
		s.register(template3a);
		AgreementTemplate template3aR = s.getAgreementTemplate(template3a
				.getID());
	...
	public void testRegistration3b() {
		...
		AgreementTemplate template3b = m
				.createAgreementTemplateFromFile(path3b);
	...
	public void testAll() {
		...
		s.register("oferta", s.getAgreementTemplate("plantilla")
				.generateAgreementOffer("cliente"));
