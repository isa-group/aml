...
public class ExpressionTest {
	...
	public static void main(String[] args) {
		...
		Expression e2 = new AssignmentExpression(b, new ArithmeticExpression(a,
				new Atomic(1), ArithmeticOperator.add));
		e2.calculate();

		Expression e3 = new AssignmentExpression(c, new ArithmeticExpression(a,
				b, ArithmeticOperator.add));
		e3.calculate();
		...
		Expression ex1 = new ArithmeticExpression(e, e2, ArithmeticOperator.add);
		Expression exp = new RelationalExpression(ex1, e3,
				RelationalOperator.eq);
		System.out.println("\n");
		System.out.println(exp.toString() + " ?: " + exp.calculate());
		...
		System.out.println("Es d == true?: "
				+ ((Boolean) d.calculate() == true));
		System.out.println("Es d == false?: "
				+ ((Boolean) d.calculate() == false));

		System.out.println("\n");

		System.out.println(exp.toString());
		System.out.println("Atomics: " + Expression.getAtomics(exp));
		System.out.println("Vars: " + Expression.getVars(exp));
		Expression.printTree(exp, 0);
