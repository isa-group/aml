...
public class ParserTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("Template: " + model.getAgreementTerms().getGuaranteeTerms().get(0).getSlo().getExpression());
		
		AgreementOffer ao = model.generateAgreementOffer("qwerty");
		System.out.println("Offer: " + ao.getAgreementTerms().getGuaranteeTerms().get(0).getSlo().getExpression());
		ao.getAgreementTerms().getGuaranteeTerms().get(0).getSlo().setExpression(new Atomic(20));
		
		System.out.println("Modified Offer: " + ao.getAgreementTerms().getGuaranteeTerms().get(0).getSlo().getExpression());
...
//		 Object[]{model.getGuaranteeTerm("G1").getSlo().getExpression(),
//		 evaluation});
//		
...
//		
//		 LOG.log(Level.INFO,
//		 "Setting MonitProp2's value to MonitProp1 * 2...\n");
//		
...
//		
//		 LOG.log(Level.INFO,
//		 "Setting MonitProp2's value to MonitProp1 * 3...\n");
//		
